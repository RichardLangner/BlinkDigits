...
- **D4** is the pin number of the LED ( you can use LED_BUILTIN ) <br>
...
BlinkDigits returns 'true' when all the digits have been flashed. See **examples** for why this is useful.<br>

## Example code
Here is a simple example which uses one line of code in loop( ) to blink out 23.<br>
...
`flasher1.config(400,1500,800, 5000); // slower timings.`<br>
- &nbsp;400 : the on/off digit 'flash' time,<br>
- 1500 : the zero digit's 'on' time<br>
- &nbsp;800 : the delay between digits<br>
- 5000 : the delay before repeating the number.<br>
